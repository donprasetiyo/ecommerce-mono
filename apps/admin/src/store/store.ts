import { LoginSlice, loginSlice } from "@admin/app/(public)/(auth)/login/slice";
import {
  RegistrationSlice,
  registrationSlice,
} from "@admin/app/(public)/(auth)/register/slice";
...
export interface BoundStore extends RegistrationSlice, LoginSlice {}
